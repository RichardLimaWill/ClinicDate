...
?>
   ...
   <section id="main-content">
      <section class="wrapper">
        <h3><b><i class="fa fa-book "></i> Relatório de Consultas por Paciente</h3></b>
               ...
               <div class="col-md-12">
                <div class="input-group date form_datetime-component">
                   <form method="POST" action="">
                      <input type="text" class="form-control" name="pesquisa" placeholder="Insira o nome do Paciente">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-user-md"></i> Paciente</th>
                    <th class="hidden-phone"><i class="fa fa-check"></i> Consulta Feita</th>
                    <th><i class="fa fa-user"></i> Médico</th>
...
if(isset($pesquisa)){
  $sqlselect = "SELECT * FROM consulta WHERE nome_paciente LIKE '%$pesquisa%' ORDER BY nome_paciente ASC ";
}else{
  $sqlselect = "SELECT * FROM consulta ORDER BY nome_paciente ASC";
}
