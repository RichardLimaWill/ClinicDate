...
$sql = mysqli_query($link, "SELECT * FROM paciente WHERE cpf = '$cpf'");
...
<html lang="en">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-pencil"><b></i>  Edição do Paciente</h3></b>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Informações Pessoais</h4>
              <form class="form-horizontal style-form" method="post" action="res_edit_paciente.php">
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <b>CPF:</b>
                    <input type="text" name="cpf"  class="form-control" readonly="" placeholder="Digite o CPF" value="<?php echo $cont['cpf']; ?>">
                  </div>
                  <div class="col-md-6">
                    <b>Nome:</b>
  ...
  <div class='modal-dialog'>
   <div class='modal-content'>
     <div class='modal-header'>
      ...
      <?php 
      echo "<a href='del_paciente.php?cpf=".$cont['cpf']."&nome=".$cont['nome']."'><button type='button' class='btn btn-danger'>Deletar</button></a>";
      ?>
      </div>
    </div>
  </div>
