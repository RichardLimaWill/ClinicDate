...
?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><b><i class="fa fa-book "></i> Relatório de Consultas por Especialidade</h3></b>
               ...
               <div class="col-md-12">
                <div class="input-group date form_datetime-component">
                  <form method="POST" action="">
                      <input type="text" class="form-control" name="pesquisa" placeholder="Insira o nome da Especialidade">
                ...
                <thead>
                  <tr>
                    <th><i class="fa fa-check"></i> Especialidade</th>
...
if(isset($pesquisa)){
  $sqlselect = "SELECT * FROM consulta WHERE consulta LIKE '%$pesquisa%' ORDER BY consulta ASC ";
}else{
  $sqlselect = "SELECT * FROM consulta ORDER BY consulta ASC";
}
